...
public class UpdateManager
{
	...
	private boolean isUpdate()
	{
		...
		try { //一个测试
			url = new URL("http://120.25.248.114:8080/OA/UpdateVersion");//创建version.xml的连接地址。
		...
		if (null != mHashMap)
		{
			...
			Toast.makeText(mContext, "mhashmap为空", Toast.LENGTH_SHORT).show();
		}
		return false;
	}
	...
	private int getVersionCode(Context context)
	{
		...
		try
		{
			...
			versionCode = context.getPackageManager().getPackageInfo("com.lilan.lanruihuanbao", 0).versionCode;
